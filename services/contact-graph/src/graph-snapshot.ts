...
const eventSummaryPhrases = {
  ...
  qr_transfer_detected: "opened a QR transfer route",
  qr_transfer_success_feedback: "received QR transfer confirmation feedback",
  qr_transfer_failure_feedback: "encountered QR transfer route feedback",
  qr_transfer_haptics_toggled: "changed QR transfer haptics",
  qr_transfer_sound_toggled: "changed QR transfer sound",
  qr_transfer_animation_toggled: "changed QR transfer animation",

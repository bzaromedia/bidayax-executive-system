...
export const eventTypeBaseScores = {
  ...
  call_click: 45,
  calendar_view: 18,
  calendar_slot_selected: 30,
  calendar_request_submitted: 42,
  calendar_request_failed: 0,
...
export const eventTypeReasonCodes = {
  ...
  calendar_view: "CALENDAR_VIEWED",
  calendar_slot_selected: "CALENDAR_SLOT_SELECTED",
  calendar_request_submitted: "CALENDAR_REQUEST_SUBMITTED",
  calendar_request_failed: "CALENDAR_REQUEST_FAILED",
...
export const actionDepthScores = {
  ...
  call_click: 20,
  calendar_view: 8,
  calendar_slot_selected: 14,
  calendar_request_submitted: 20,
  calendar_request_failed: 0,

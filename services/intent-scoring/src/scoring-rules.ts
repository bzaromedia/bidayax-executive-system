...
export const eventTypeBaseScores = {
  ...
  website_click: 15,
  share_click: 18,
  qr_transfer_detected: 4,
  qr_transfer_success_feedback: 1,
  qr_transfer_failure_feedback: 0,
  qr_transfer_haptics_toggled: 0,
  qr_transfer_sound_toggled: 0,
  qr_transfer_animation_toggled: 0,
  vcard_download: 25,
  email_click: 35,
  call_click: 45,
  calendar_view: 18,
...
export const eventTypeReasonCodes = {
  ...
  qr_transfer_detected: "QR_TRANSFER_DETECTED",
  qr_transfer_success_feedback: "QR_TRANSFER_SUCCESS_FEEDBACK",
  qr_transfer_failure_feedback: "QR_TRANSFER_FAILURE_FEEDBACK",
  qr_transfer_haptics_toggled: "QR_TRANSFER_HAPTICS_TOGGLED",
  qr_transfer_sound_toggled: "QR_TRANSFER_SOUND_TOGGLED",
  qr_transfer_animation_toggled: "QR_TRANSFER_ANIMATION_TOGGLED",
...
export const actionDepthScores = {
  ...
  website_click: 8,
  share_click: 10,
  qr_transfer_detected: 0,
  qr_transfer_success_feedback: 0,
  qr_transfer_failure_feedback: 0,
  qr_transfer_haptics_toggled: 0,
  qr_transfer_sound_toggled: 0,
  qr_transfer_animation_toggled: 0,

...
type Phase2CTemporaryPreviewState = {
      ...
      <CardContent className="space-y-4">
        ...
        <div className="rounded-bxLg border border-border-subtle bg-surface-inset p-4">
          <p className="text-sm leading-relaxed text-content-secondary">
            ...
            will be connected to the publish flow in Phase 2D.
          </p>
        </div>
      </CardContent>
    </Card>
...
function ResolvedTokenPreview({ item }: { readonly item: Phase2CTemporaryPreviewState }) {
  return (
    <Card>
      <CardHeader>
        <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
          <div>
            ...
            <CardDescription>
              Temporary Phase 2C preview state generated by the Phase 2B token
              resolver. This is not persisted yet.
            </CardDescription>
          </div>
...
function PublishReadinessPanel({ item }: { readonly item: Phase2CTemporaryPreviewState }) {
  const checks = [
    ...
    ["Database persistence deferred", false]
  ] as const;
      ...
      <CardHeader>
        <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
          <div>
            ...
            <CardDescription>
              Phase 2C provides preview gating only. Immutable version publishing
              is the Phase 2D boundary.
            </CardDescription>
          </div>
...
export function CardCustomizationSettings({
  ...
  const previewState = createTemporaryPreviewState(settings);

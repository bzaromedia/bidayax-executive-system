...
export const eventTypeLabels = {
  ...
  qr_transfer_detected: "QR transfer detections",
  qr_transfer_success_feedback: "QR feedback confirmations",
  qr_transfer_failure_feedback: "QR feedback issues",
  qr_transfer_haptics_toggled: "QR haptics toggles",
  qr_transfer_sound_toggled: "QR sound toggles",
  qr_transfer_animation_toggled: "QR animation toggles",
  calendar_view: "Calendar views",
  calendar_slot_selected: "Calendar slot selections",
  calendar_request_submitted: "Calendar requests",
  calendar_request_failed: "Calendar errors",

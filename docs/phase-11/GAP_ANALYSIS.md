...
| Advisor gates | Gate A and Gate B are supported by PR #12 Advisor approval; Gate C requires the final closure Advisor review. | Record final Gate C evidence in the closure PR and final report before merge. |

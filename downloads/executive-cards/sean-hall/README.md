# Sean Hall Executive Card Package

This package contains the isolated production card assets for Sean Hall.

## Contents

- `profile.json` contains this executive profile and card URL.
- `sean-hall.vcf` contains this executive contact card.

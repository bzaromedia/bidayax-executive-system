# Naimah J. Barnes Executive Card Package

This package contains the isolated production card assets for Naimah J. Barnes.

## Contents

- `profile.json` contains this executive profile and card URL.
- `naimah-barnes.vcf` contains this executive contact card.
